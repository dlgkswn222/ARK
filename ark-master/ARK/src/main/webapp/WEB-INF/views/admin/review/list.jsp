...
<table>
 ...
 <tbody class="b">
  ...
  <tr>
   ...
   <td>${list.num}</td>
   <td><img style="height: 100px; width: 100px;" src="/resources/images/upload${list.gdsImg}"></td>
   <td>${list.title}</td>
   <td>${list.writer}</td>
    <td><fmt:formatDate value="${list.ttdate}" pattern="yyyy-MM-dd" /></td>
   <td>${list.count}</td>
...
value="${_csrf.token }"/>
				...
				<div class="col-lg-12">
					<form id="searchForm" action="/admin/review/list" method="get">
						&nbsp;&nbsp;&nbsp;<select name="type">
